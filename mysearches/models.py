...
class SavedSearch(models.Model):
    ...
    # in the delete_user pre_delete signal defined in usermodel/models.py.
    user = models.ForeignKey('usermodel.User', editable=False, null=True,
    ...
    def send_email(self, custom_msg=None, additional_categories=None,
        ...
        if self.user.can_receive_usermodel_email():
            ...
            log_kwargs['reason'] = "User can't receive usermodel email"
...
class SavedSearchDigest(models.Model):
    ...
    user = models.OneToOneField('usermodel.User', editable=False)
    email = models.EmailField(max_length=255)
    frequency = models.CharField(max_length=2, choices=FREQUENCY_CHOICES,
                                 default='D',
    ...
    def send_email(self, custom_msg=None):
        ...
        if self.user.can_receive_usermodel_email() and saved_searches:
            log_kwargs['was_sent'] = True
            context_dict = {
...
class SavedSearchLog(models.Model):
    was_sent = models.BooleanField(default=None)
    was_received = models.BooleanField(default=None,
