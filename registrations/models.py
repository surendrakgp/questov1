...
class ActivationProfile(models.Model):
    user = models.ForeignKey('usermodel.User', verbose_name="user")
...
class Invitation(models.Model):
    ...
    """
    inviting_user = models.ForeignKey('usermodel.User', editable=False,
                                      related_name='invites_sent',
                                      null=True)
    #inviting_company = models.ForeignKey('seo.Company', blank=True, null=True,
    #                                     related_name='invites_sent')
    invitee = models.ForeignKey('usermodel.User', related_name='invites',
